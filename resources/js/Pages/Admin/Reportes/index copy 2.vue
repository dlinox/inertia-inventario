...
<v-container>
  <div class="text-center">
    ...
    <div class="col-xs-12  mt-4 botones" style=" width:100%; height: 60px; display: flex; justify-content: flex-end; margin: auto; align-items: center; background-color: white;" >
            <div class="">
                <v-btn height="38" class="btn" dark color="primary" @click="verPDF">Generados</v-btn>
            </div>
            <div class="ml-2">
    ...
    <div class="mt-4 pl-4 p-4"  style="margin: 0px -30px; background-color: white; " >
            <v-card-title>
                <v-text-field
            ...
            <template v-slot:item.acciones="{ item }">
                 <div class="flex">
                    <v-btn class="ml-0 p-0" style="width: 25px; height:25px;;" icon color="primary" @click="desbloquear(item)" >
                    ...
                    <v-btn style="width: 25px; height:25px;;" icon color="primary" @click="eliminarDocumento(item)" >
