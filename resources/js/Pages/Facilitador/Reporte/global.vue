            ...
            <th colspan="5">
              <div class="">
                <div class="d-flex" style="justify-content: space-between; align-items: center;">
                  <div>
                    <span style="font-weight: bold; font-size: 1.3rem;"> Reporte de Avance Global del {{voltear(fecha)}} </span>
                    <h2>Registro bienes</h2>
                  </div>
                  <div class="pt-5">
                    <v-menu
                      v-model="menu"
...
export default {
    ...
    methods: {
      async getDatos() {
          let res = await axios.get("/reporte-global-dia/"+this.fecha);
